...
export default {
  data() {
    return {
      title: "摄像头预览",
      visible: false,
      // rtsp: "rtsp://admin:gx123456@192.168.1.154/h264/ch1/main/av_stream", //视频配置
      rtsp: "rtsp://192.168.1.199:554/huh", //视频配置
      player: null,
      loading: false
    };
  },
    ...
    handlePlay(item) {
      ...
      if (flvjs.isSupported()) {
        ...
        player = flvjs.createPlayer({
          ...
          url: `ws://localhost:8888/rtsp/LivePlayer/?url=${encodeURIComponent(this.rtsp)}` //视频流地址
        });
